...
const rejectProposal = {
  ...
  schema: {
    ...
    transactionIndex: z.union([z.string(), z.number()]).describe("The transaction index to reject (as string or number)."),
    member: z.string().describe("The public key of the member rejecting the proposal."),
  },
